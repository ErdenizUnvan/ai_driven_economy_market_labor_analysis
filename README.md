...
-Time-series cleaning, alignment, and visualization

-Prophet forecasts for both S&P 500 and Job Openings

-Analysis of labor market cooling

-Analysis of AI-driven equity growth

-Macro interpretation of the “AI-era decoupling”

-Combined chart: S&P 500 vs Job Openings (Past + Forecast)

-Jupyter notebook with full reproducible code

This project highlights the emerging post-labor elasticity economy, where AI allows corporations to grow without proportional increases in hiring, leading to a clear divergence between market valuations and labor demand.
